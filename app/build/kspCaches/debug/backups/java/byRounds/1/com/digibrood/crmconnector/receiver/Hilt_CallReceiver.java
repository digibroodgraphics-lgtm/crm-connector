...
public abstract class Hilt_CallReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((CallReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectCallReceiver(UnsafeCasts.<CallReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
